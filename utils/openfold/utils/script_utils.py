...
from utils.openfold.model.model import AlphaFold  # , AlphaFoldDECODER
from utils.openfold.np import protein, residue_constants
from utils.openfold.np.relax import relax
from utils.openfold.utils.import_weights import import_jax_weights_
